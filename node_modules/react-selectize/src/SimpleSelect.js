(function(){
  ...
  module.exports = React.createClass({
    ...
    render: function(){
      var ref$, filteredOptions, onOpenChange, onSearchChange, onValueChange, open, options, search, value, values, autofocus, autosize, delimiters, disabled, dropdownDirection, groupId, groups, groupsAsColumns, name, renderGroupTitle, serialize, tether, transitionEnter, transitionLeave, transitionEnterTimeout, transitionLeaveTimeout, uid, this$ = this;
